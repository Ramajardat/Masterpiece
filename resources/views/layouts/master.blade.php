                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    <a href="{{ asset('/') }}"><img src="assets/img/logo/logo.png"
                                            alt=""></a>
                                </div>
                            </div>
                            <div class="col-xl-10 col-lg-10 col-md-8">
                                <div class="header-left  d-flex f-right align-items-center">
                                            ...
                                            <ul id="navigation">
                                                ...
                                                @guest
                                                    ...
                                                    <li class="nav-item"><a class="nav-link" aria-current="page"
                                                            href="{{ asset('/login') }}">Login</a></li>
                                                @else
                                                    @can('user')
                                                        <li class="nav-item dropdown">

                                                            <a class="nav-link dropdown-toggle" id="navbarDropdown"
                                                                style="border-radius:0" href="{{ asset('/profile') }}"
                                                            ...
                                                            <ul class="dropdown-menu" id="dropdown-menu">
                                                                <li class="dropdown-item"><a
                                                                        class="dropdown-item block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out"
                                                                        href="{{ asset('/profile') }}">Profile</a></li>
                                                                <li>
                                    ...
                                    <div class="header-right-btn f-right d-none d-lg-block  ml-30">
                                        @can('Admin')
                                            <a href="{{ asset('/admin/dashboard') }}" class="header-btn">dashboard</a>
                                        @endcan
                                        @guest
                                        ...
                                        @endguest
                                        @can('user')
                                            <a href="{{ asset('/appointment') }}" class="header-btn">Make an
                                                Appointment</a>
                                        @endcan
                                    </div>
                                </div>
                            ...
                            <div class="single-footer-caption mb-50">
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-social">
                                        <a href="https://twitter.com/jardat_rama"><i class="fab fa-twitter"></i></a>
                                        <a href="https://www.facebook.com/Consilia-107115075582816/"><i
                                                class="fab fa-facebook-f"></i></a>
                                        <a href="https://www.youtube.com/channel/UCFUeJFY7dqXcTJDtsQgiLig"><i
