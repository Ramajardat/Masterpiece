                    ...
                    <div class="hero-caption">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ asset('/appointment') }}">Make An Appointment</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                                ...
                                <select class="form-select" aria-label="Default select example" name="appointment_time"
                                    ...
                                    @foreach ($conArr as $user)
                                        ...
                                        @if ($user['is_available'] == true)
                                            <option value="{{ $user['id'] }},{{ $user['available_time'] }}">
                                                {{ $userCon['name'] }}/{{ $user['available_time'] }}</option>
                                        @endif
                                    @endforeach
